...
export class UsuariosService {
  ...
  createUs(){
    const usuarios =[
      {id: 1, dni:'4876589W', nom:'Juan Carlos', ap:'Lopez Sempere', us: 'jcls', pas:'1234', f:Blob, dir:'C. de las lomas blancas', tel:634986426,t_us:'1',ac:true },
      {id: 1, dni:'7866984R', nom:'Zaira', ap:'Lopez Sempere', us: 'zls', pas:'1234', f:Blob, dir:'C. de las lomas blancas', tel:634983216,t_us:'1',ac:true },
      {id: 1, dni:'9158972E', nom:'Emma', ap:'Requena Lopez', us: 'erl', pas:'1234', f:Blob, dir:'Plaza la viña', tel:695866216,t_us:'1',ac:true }
    ];
    return{usuarios};
  }
  createCs(){
